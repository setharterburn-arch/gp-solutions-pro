...
export default function NewEstimatePage() {
  ...
  const handleSave = async (send: boolean = false) => {
    ...
    if (!estimate.title) {
      alert('Please enter a title for this estimate')
      setSaving(false)
      return
    }
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Create and send a quote to your customer</p>
          </div>
        </div>
        ...
        {estimate.customer_name ? (
          <div className="flex items-start justify-between p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-gray-500">{estimate.customer_address}</p>
            </div>
            <button
              onClick={() => setEstimate({ ...estimate, customer_id: '', customer_name: '', customer_email: '', customer_phone: '', customer_address: '' })}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-gray-700 mb-1">Title / Project Name</label>
            <input
              type="text"
